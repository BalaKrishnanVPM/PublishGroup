...
public class AccessExcel 
{
	...
	public void doAction(WebDriver driver,WebElement element,Map<String, String> objects,String getGroupname, Logger logger) throws InterruptedException, IOException
	{
